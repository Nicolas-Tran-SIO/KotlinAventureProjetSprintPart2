...
/**
* La classe GenerateurTypeArme permet de générer des types d'armes à partir d'un fichier CSV.
*
...
class GenerateurTypeArme(val cheminFichier: String) {
     ...
     *
     * @return Un mapping des types d'armes où la clé est le nom du type d'arme en minuscules..
     */
